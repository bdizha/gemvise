...
export const blogPosts: BlogPost[] = [
  {
    ...
    date: '2025-04-06',
    author: 'Gemium Team',
    excerpt: 'At Gemium, we are architecting the foundational layers for the future of interaction. Simple text-based dialogue is merely the first step.',
    content: `At Gemium, we are architecting the foundational layers for the future of interaction. Simple text-based dialogue is merely the first step. To enable truly complex AI entities and pave the way for the Gemium, we must expand the bandwidth of interaction.

Today, we announce the integration of visual data streams into the Gemium platform. This allows Architects (our creators) to define AI Constructs capable of processing and responding to visual input, and crucially, generating visual output as part of their interaction protocol.
