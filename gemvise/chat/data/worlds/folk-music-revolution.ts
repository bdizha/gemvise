...
export const folkRevolutionScenes25: Gem[] = [
  { id: 'coffee-house-performance-25', name: 'Coffee House Performance', description: 'Harmony performs an intimate set at a local coffee house.', genres: ['Music', 'Drama'], type: 'Scene', world: 'folk-revolution', attributes: { power: 0, rarity: 'Common', level: 1, traits: ['intimate', 'acoustic', 'local'] } },
  { id: 'backstage-argument-25', name: 'Backstage Argument', description: 'Harmony and Midas clash over creative differences.', genres: ['Drama'], type: 'Scene', world: 'folk-revolution', attributes: { power: 0, rarity: 'Common', level: 1, traits: ['conflict', 'artisticdifferences'] } },
  { id: 'protest-march-song-25', name: 'Protest March Song', description: 'Harmony leads a crowd in song during a protest march.', genres: ['Music', 'Drama'], type: 'Scene', world: 'folk-revolution', attributes: { power: 0, rarity: 'Common', level: 1, traits: ['protest', 'marching', 'unity'] } },
  { id: 'interview-with-ronnie-25', name: 'Interview with Ronnie', description: 'Harmony discusses her music and activism on Ronnie Radio\'s show.', genres: ['Drama'], type: 'Scene', world: 'folk-revolution', attributes: { power: 0, rarity: 'Common', level: 1, traits: ['interview', 'radio', 'discussion'] } },
  { id: 'meeting-old-man-ballad-25', name: 'Meeting Old Man Ballad', description: 'Harmony has a conversation with Old Man Ballad about the changing times.', genres: ['Drama', 'Music'], type: 'Scene', world: 'folk-revolution', attributes: { power: 0, rarity: 'Common', level: 1, traits: ['dialogue', 'traditionvschange'] } },
  { id: 'senator-stone-threat-25', name: 'Senator Stone Threatens', description: 'Senator Stone confronts Harmony about her influence.', genres: ['Drama'], type: 'Scene', world: 'folk-revolution', attributes: { power: 0, rarity: 'Common', level: 1, traits: ['confrontation', 'threat'] } },
  { id: 'melody-follower-inspired-25', name: 'Melody Follower Inspired', description: 'Melody Follower attends one of Harmony\'s concerts and is deeply moved.', genres: ['Drama', 'Music'], type: 'Scene', world: 'folk-revolution', attributes: { power: 0, rarity: 'Common', level: 1, traits: ['inspiration', 'fan', 'concert'] } },
  { id: 'writing-session-25', name: 'Late Night Writing Session', description: 'Harmony stays up late, passionately working on a new protest song.', genres: ['Music', 'Drama'], type: 'Scene', world: 'folk-revolution', attributes: { power: 0, rarity: 'Common', level: 1, traits: ['songwriting', 'passion', 'lateNight'] } },
  { id: 'press-conference-25', name: 'Press Conference Confrontation', description: 'Harmony faces tough questions from Penny Prickle at a press conference.', genres: ['Drama'], type: 'Scene', world: 'folk-revolution', attributes: { power: 0, rarity: 'Common', level: 1, traits: ['pressconference', 'scrutiny'] } },
  { id: 'planning-meeting-25', name: 'Activist Planning Meeting', description: 'Harmony and River strategize with other activists.', genres: ['Drama'], type: 'Scene', world: 'folk-revolution', attributes: { power: 0, rarity: 'Common', level: 1, traits: ['planning', 'strategy', 'activism'] } },
];
...
export const folkMusicRevolutionData: World = {
  ...
  shortDescription: '1960s folk music and protest songs.',
  longDescription: 'Immerse yourself in the heart of the 1960s folk music scene with Harmony Hope, a singer whose voice ignites a movement. Navigate the challenges of activism, the clash between traditional and modern sounds with Old Man Ballad, and the allure of commercial success offered by Midas Touch Musicman. Witness how music inspires figures like Melody Follower and draws scrutiny from Senator Stone and cynical journalist Penny Prickle. This world explores the power of song to shape a generation.',
  tone: ['Passionate', 'Dramatic', 'Inspiring', 'Reflective'],
  genres: ['Drama', 'Music'],
  themes: ['Social Justice', 'Activism', 'Power of Music', 'Generational Clash', 'Artistic Integrity'],
  vibes: ['Hopeful Rebellion', 'Soulful Melodies', 'Counter-Culture'],
  eras: ['1960s'],
  locations: ['Coffee Houses', 'Protest Rallies', 'Recording Studios', 'University Campuses'],
  characters: folkRevolutionCharacters25,
  stories: folkRevolutionStories25,
  adventures: folkRevolutionAdventures25,
  scenes: folkRevolutionScenes25,
};
