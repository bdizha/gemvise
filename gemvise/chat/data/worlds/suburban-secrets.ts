...
export const suburbanSecretsData: World = {
  ...
  themes: ['Conformity vs Individuality', 'Secrets', 'Reputation', 'Social Norms'],
  vibes: ['Unsettling', 'Nostalgic with a Twist', 'Intriguing'],
  eras: ['1950s'],
  locations: ['Suburban Neighborhoods', 'Homes', 'Community Gatherings'],
};
