...
export const CategorySection: Gem[] = [
  {
    ...
    imageUrl: '/gradients/named/GV-Gradient-Dark.png',
  ...
  },
  {
    ...
    category: 'Unhinged Comedian',
    imageUrl: '/gradients/named/GV-Gradient-Dark-Light.png',
  ...
  },
  {
    ...
    category: 'Not a Doctor',
    imageUrl: '/gradients/named/GV-Gradient-Light-Dark.png',
  ...
  },
  {
    ...
    category: 'Not a Therapist',
    imageUrl: '/gradients/named/GV-Gradient-Dark-Light-Dark.png',
...
export const allGems: Gem[] = [
  ...
  },
  {
    ...
    category: 'Unhinged Comedian',
    imageUrl: '/gradients/named/GV-Gradient-Light-Dark-Light.png',
    gradient: 'bg-gradient-to-r from-violet-DEFAULT to-pink-DEFAULT',
  ...
  },
  {
    ...
    category: 'Not a Therapist',
    imageUrl: '/gradients/named/GV-Gradient-Dark-Light-Dark-Long.png',
    gradient: 'bg-gradient-to-r from-pink-DEFAULT to-violet-DEFAULT',
