...
export default function ResearchPaperPage({ params }: ResearchPaperPageProps) {
  ...
  return (
    <div>
      <div>
        <Link href="/research" className="block mb-6 text-secondary hover:text-primary">
          <svg
        ...
        <p className="text-neutral-300 mt-6 text-lg max-w-xl">{paper.abstract}</p>
